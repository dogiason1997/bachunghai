...
public class UnitAgency {
    ...
    @Column(name = "Name_Unit", nullable = false, length = 100, columnDefinition = "NVARCHAR(100)")
    private String nameUnit;

    @Column(name = "Unit_Code", nullable = false, length = 50, columnDefinition = "NVARCHAR(100)",unique = true)
